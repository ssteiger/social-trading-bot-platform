  ...
  const columns: ColumnDef<Company>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="font-medium">
          <Link href={`/stocks/${row.original.company_id}`} className="hover:underline">
    ...
    },
    {
      ...
      cell: ({ row }) => <div>{row.original.total_shares.toLocaleString()}</div>,
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button size="sm" variant="outline" asChild>
          <Link to={`/stocks/${row.original.company_id}`}>View</Link>
        </Button>
      ),
    },
  ]
