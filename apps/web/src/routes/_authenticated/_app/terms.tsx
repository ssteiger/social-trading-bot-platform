	...
	return (
		<div className="container max-w-3xl py-10">
			...
			<div className="prose prose-sm">
				<p>
					Welcome to Social Trading Bots. By using our service, you agree to
					these terms.
				</p>
				...
				<p>
					By accessing or using the Social Trading Bots platform, you agree to
				...
				<p>
					Permission is granted to temporarily use the Social Trading Bots
				...
				<p>
					The materials on Social Trading Bots' platform are provided on an 'as
					is' basis. Social Trading Bots makes no warranties, expressed or
				...
				<p>
					In no event shall Social Trading Bots or its suppliers be liable for
					...
					inability to use the materials on Social Trading Bots' platform, even
					if Social Trading Bots or a Social Trading Bots authorized
