  ...
  return (
    <div className="container max-w-3xl py-10">
      ...
      <div className="prose prose-sm">
        <p>
          At Social Trading Bots, we take your privacy seriously. This Privacy Policy explains how
        ...
        <p>
          ...
          on the platform, express interest in obtaining information about us or our products and
        ...
        <p>
          ...
          develop new ones, and to protect our platform and our users.
        </p>
